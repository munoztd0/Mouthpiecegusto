...
pacman::p_load(tidyverse, dplyr, plyr, Rmisc, afex, BayesFactor) 

# get tool
devtools::source_gist("2a1bb0133ff568cbe28d", 
                      filename = "geom_flat_violin.R")
source('~/OBIWAN/CODE/ANALYSIS/GUSTO/cohen_d_ci.R', echo=F)
source('~/OBIWAN/CODE/ANALYSIS/GUSTO/pes_ci.R', echo=F)
